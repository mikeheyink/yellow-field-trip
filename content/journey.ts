...
export const journey: JourneyItem[] = [
  ...
  { kind: 'stop', slug: 'zakeyu', time: '12:00', title: 'Zakeyu', subtitle: 'Customer · TA Chitukula' },
  { kind: 'chapter', slug: 'the-digital-breakthrough' },
  { kind: 'stop', slug: 'hendrix', time: '12:30', title: 'Hendrix', subtitle: 'Customer · TA Chitukula' },
  { kind: 'inter', title: 'Lunch', time: '13:00' },
  { kind: 'chapter', slug: 'scale' },
  { kind: 'stop', slug: 'agent-lawrence', time: '', title: 'Meet Lawrence', subtitle: 'Agent · TA Malili' },
  { kind: 'stop', slug: 'memory', time: '15:00', title: 'Memory', subtitle: 'Customer · TA Malili' },
  { kind: 'chapter', slug: 'the-2022-crisis' },
  { kind: 'stop', slug: 'john', time: '15:30', title: 'John', subtitle: 'Customer · TA Malili' },
